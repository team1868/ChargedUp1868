 ...
 * calculus" to create new RigidTransform2d's from a Twist2d and visa versa. <p> A Twist can be used
 * to represent a difference between two poses, a velocity, an acceleration, etc.
 */
public class Twist2d {
  ...
  public boolean epsilonEquals(final Twist2d other, double epsilon) {
    return Util.epsilonEquals(dx, other.dx, epsilon) && Util.epsilonEquals(dy, other.dy, epsilon)

...
public class Translation2d implements ITranslation2d<Translation2d> {
   ...
   */
  public Translation2d rotateBy(final Rotation2d254 rotation) {
  ...
  public Rotation2d254 direction() {
    return new Rotation2d254(x_, y_, true);
  }
  ...
  public static Rotation2d254 getAngle(final Translation2d a, final Translation2d b) {
    double cos_angle = dot(a, b) / (a.norm() * b.norm());
    if (Double.isNaN(cos_angle)) {
      return new Rotation2d254();
    }
    return Rotation2d254.fromRadians(Math.acos(Util.limit(cos_angle, 1.0)));
  }

...
public class Pose2d implements IPose2d<Pose2d> {
  ...
  protected final Rotation2d254 rotation_;

  public Pose2d() {
    translation_ = new Translation2d();
    rotation_ = new Rotation2d254();
  }

  public Pose2d(double x, double y, final Rotation2d254 rotation) {
    translation_ = new Translation2d(x, y);
    rotation_ = rotation;
  }

  public Pose2d(final Translation2d translation, final Rotation2d254 rotation) {
  ...
  public static Pose2d fromTranslation(final Translation2d translation) {
    return new Pose2d(translation, new Rotation2d254());
  }

  public static Pose2d fromRotation(final Rotation2d254 rotation) {
  ...
  public static Pose2d exp(final Twist2d delta) {
    ...
    return new Pose2d(
        ...
        new Rotation2d254(cos_theta, sin_theta, false)
    );
  }
  ...
  public static Twist2d log(final Pose2d transform) {
    ...
    final Translation2d translation_part = transform.getTranslation().rotateBy(
        new Rotation2d254(halftheta_by_tan_of_halfdtheta, -half_dtheta, false)
    );
  ...
  @Override
  public Pose2d rotateBy(Rotation2d254 other) {
  ...
  public Pose2d inverse() {
    Rotation2d254 rotation_inverted = rotation_.inverse();
  ...
  public Translation2d intersection(final Pose2d other) {
    final Rotation2d254 other_rotation = other.getRotation();
  ...
  private static Translation2d intersectionInternal(final Pose2d a, final Pose2d b) {
    final Rotation2d254 a_r = a.getRotation();
    final Rotation2d254 b_r = b.getRotation();

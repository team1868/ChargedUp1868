...
public class QuinticHermiteSpline extends Spline {
  ...
  public Pose2d getStartPose() {
    return new Pose2d(new Translation2d(x0, y0), new Rotation2d254(dx0, dy0, true));
  }

  public Pose2d getEndPose() {
    return new Pose2d(new Translation2d(x1, y1), new Rotation2d254(dx1, dy1, true));
  }
  ...
  @Override
  public Rotation2d254 getHeading(double t) {
    return new Rotation2d254(dx(t), dy(t), true);
  }
   ...
   */
  private static class ControlPoint { private double ddx, ddy; }
  ...
  private static double fitParabola(Translation2d p1, Translation2d p2, Translation2d p3) {
    ...
    double B =
        (p3.x() * p3.x() * (p1.y() - p2.y()) + p2.x() * p2.x() * (p3.y() - p1.y())
         + p1.x() * p1.x() * (p2.y() - p3.y()));
    return -B / (2 * A);
  }
}

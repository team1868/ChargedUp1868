...
public class TargetLockedFieldRelativeController implements IDriveController {
  ...
  public ChassisSpeeds transform(DriveInput driveInput, Pose2d robotPose) {
    ...
    // if ((mSwerveHeadingController.getHeadingControllerState()
    ...
    //   mSwerveHeadingController.setHeadingControllerState(
    //       SwerveHeadingController.HeadingControllerState.POLAR_MAINTAIN
    //   );
    //   mSwerveHeadingController.setGoal(mSwerveHeadingController.calculateAngleToOrigin(
    //       mRobotState.getLatestFieldToVehicle().getValue()
    //   ));
    // } else {
    //   mSwerveHeadingController.setHeadingControllerState(
    //       SwerveHeadingController.HeadingControllerState.POLAR_SNAP

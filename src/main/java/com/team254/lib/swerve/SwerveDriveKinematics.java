...
public class SwerveDriveKinematics {
  ...
  private final Rotation2d254[] m_rotations;
  ...
  public SwerveDriveKinematics(Translation2d... wheelsMeters) {
    ...
    m_rotations = new Rotation2d254[m_numModules];
    ...
    for (int i = 0; i < m_numModules; i++) {
      ...
      m_rotations[i] = new Rotation2d254(m_modules[i].x(), m_modules[i].y(), true);
    }
  ...
  public SwerveModuleState[] toSwerveModuleStates(
    ...
    for (int i = 0; i < m_numModules; i++) {
      ...
      Rotation2d254 angle = new Rotation2d254(x, y, true);
  ...
  public ChassisSpeeds toChasisSpeedWheelConstraints(SwerveModuleState... wheelStates) {
    ...
    for (int i = 0; i < m_numModules; i++) {
      ...
      var beta = module.angle.rotateBy(m_rotations[i].inverse())
                     .rotateBy(Rotation2d254.fromRadians(Math.PI / 2.0));

      // System.out.println(module);
      constraintsMatrix.setRow(
          i * 2, 0, module.angle.cos(), module.angle.sin(), -m_modules[i].norm() * beta.cos()
      );
      constraintsMatrix.setRow(
          i * 2 + 1, 0, -module.angle.sin(), module.angle.cos(), m_modules[i].norm() * beta.sin()
      );
    }

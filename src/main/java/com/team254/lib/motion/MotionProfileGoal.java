...
public class MotionProfileGoal implements IMotionProfileGoal {
  ...
  public boolean atGoalState(MotionState state) {
    return atGoalPos(state.pos())
        && (Math.abs(state.vel()) < (max_vel + vel_tolerance)
  ...
  public String toString() {
    return "pos: " + pos + " (+/- " + pos_tolerance + "), max_vel: " + max_vel + " (+/- "
        + vel_tolerance + "), completion behavior: " + completion_behavior.name();
  }
  ...
  public boolean equals(Object obj) {
    ...
    return (other.completion_behavior() == completion_behavior()) && (other.pos() == pos())
        ...
        && (other.pos_tolerance() == pos_tolerance()) && (other.vel_tolerance() == vel_tolerance());
  }
}

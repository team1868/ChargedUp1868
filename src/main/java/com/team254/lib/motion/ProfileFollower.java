...
public class ProfileFollower {
   ...
   *
   * @param latest_state The latest *actual* state, used only for feedback purposes (unless this is
   *     the first iteration or
   *                     reset()/resetSetpoint() was just called, in which case this is the new
   * start state for the profile).
  ...
  public synchronized double update(MotionState latest_state, double t) {
    ...
    double output = mKp * mLatestPosError + mKv * mLatestVelError

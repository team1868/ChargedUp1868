...
public class AimingParameters {
  ...
  private final Rotation2d254 robot_to_goal_rotation;
  private final int track_id;
  private final boolean is_latest;

  public AimingParameters(
      Pose2d field_to_vehicle, Pose2d field_to_goal, int track_id, boolean is_latest
  ) {
  ...
  public Rotation2d254 getRobotToGoalRotation() {

 ...
 * determination <em>R</em><sup>2</sup>. <p> This implementation performs a QR-decomposition of the
 * underlying Vandermonde matrix, so it is not the fastest or most numerically stable way to perform

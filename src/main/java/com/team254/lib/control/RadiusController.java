  ...
  public double update(double current_radius) {
    ...
    switch (mRadiusControllerState) {
      case OFF:
        ...
        //         Constants.kSnapRadiusKp, Constants.kSnapRadiusKi, Constants.kSnapRadiusKd
        //     );
        //     break;
        //   case MAINTAIN:
        //     mPIDFController.setPID(
        //         Constants.kMaintainRadiusKp, Constants.kMaintainRadiusKi,
        //         Constants.kMaintainRadiusKd
        //     );
        //     break;
    }

...
public class Constants {
  // TODO resolve usage and centralize
  ...
  public static final SwerveDriveKinematics kKinematics = new SwerveDriveKinematics(
      // Front left
      new Translation2d(
          Constants.kDriveTrackwidthMeters / 2.0, Constants.kDriveWheelbaseMeters / 2.0
      ),
      // Front right
      new Translation2d(
          Constants.kDriveTrackwidthMeters / 2.0, -Constants.kDriveWheelbaseMeters / 2.0
  ...
  public static final Rotation2d254 kBackLeftAziEncoderOffset =
      kPracticeBot ? Rotation2d254.fromDegrees(272.285) : Rotation2d254.fromDegrees(283.62);
  ...
  public static final Rotation2d254 kBackRightAziEncoderOffset =
      kPracticeBot ? Rotation2d254.fromDegrees(194.67) : Rotation2d254.fromDegrees(201.5);

  public static final CanDeviceId kFrontRightDriveTalonId =
      new CanDeviceId(12, kCANivoreCANBusName);
  public static final CanDeviceId kFrontRightAziTalonId = new CanDeviceId(11, kCANivoreCANBusName);
  public static final CanDeviceId kFrontRightEncoderPortId =
      new CanDeviceId(13, kCANivoreCANBusName);
  public static final Rotation2d254 kFrontRightAziEncoderOffset =
      kPracticeBot ? Rotation2d254.fromDegrees(103.45) : Rotation2d254.fromDegrees(67.5);
  ...
  public static final CanDeviceId kFrontLeftEncoderPortId =
      new CanDeviceId(10, kCANivoreCANBusName);
  public static final Rotation2d254 kFrontLeftAziEncoderOffset =
      kPracticeBot ? Rotation2d254.fromDegrees(14.5) : Rotation2d254.fromDegrees(10.75);
  ...
  // Left Intake
  public static final CanDeviceId kLeftIntakeMotorId =
      new CanDeviceId(15, Constants.kCANivoreCANBusName);
  ...
  public static final double kShooterTicksPerRevolution = 2048.0
      / (14.0 / 72.0); // based on gear reduction between encoder and output shaft, and encoder port
  ...
  public static final ServoMotorSubsystemConstants kTurretConstants =
      new ServoMotorSubsystemConstants();
  static {
    ...
    kTurretConstants.kTicksPerUnitDistance =
        1.0 / (1.0 / 2048.0 * 11.0 / 38.0 * 10.0 / 130.0 * 360.0);
    ...
    kTurretConstants.kKf = 0.045; // Tuned by Sending 0.4 percent output to turret motor and
                                  // measuring closed loop velocity
  ...
  // Hood
  public static final ServoMotorSubsystemConstants kHoodConstants =
      new ServoMotorSubsystemConstants();
  static {
    ...
    kHoodConstants.kTicksPerUnitDistance =
        1.0 / ((1.0 / 2048.0) * (16.0 / 56.0) * (14.0 / 42.0) * (14.0 / 510.0) * 360.0);
  ...
  // Goal Tracker
  public static final GoalTracker.Configuration kGoalTrackerConstants =
      new GoalTracker.Configuration();
  static {
    kGoalTrackerConstants.kMaxTrackerDistance = 1.0; // m
    kGoalTrackerConstants.kMaxGoalTrackAge =
        kLimelightSnapshotMode ? Double.MAX_VALUE : 20.0; // seconds
  ...
  public static final Rotation2d254 kHorizontalPlaneToLens =
      Rotation2d254.fromDegrees(35.7); // Measured on comp bot
  public static final double kVisionTargetHeight = 2.64;
  public static final double kTurretRotationFudgeFactor = -1.5;
  public static final Pose2d kTurretToLens = new Pose2d(
      new Translation2d(-0.1882556, 0.0), Rotation2d254.fromDegrees(kTurretRotationFudgeFactor)
  ); // Turret center to sensor
  ...
  public static double[][] kHoodValues = {
      {6.7, 25}, {5.5, 21.66}, {4.5, 19.2}, {3.5, 12}, {2.5, 7}, {2, 4.5}, {1.5, 0}};
  ...
  public static final double kClimberTicksToInches = 1.0 / 2048.0 * 11.0 / 40.0 * 22.0 / 38.0 * 14.0
      / 48.0 // ticks to sprocket revs
      * 0.25 / Math.sin(Math.toRadians(180.0 / 22.0))
      * Math.PI; // sprocket revs to inches of travel

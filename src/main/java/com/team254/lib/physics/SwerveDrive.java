...
public class SwerveDrive {
  ...
  // skid steer.  Measure by turning the robot in place several times and figuring out what the
  // equivalent wheelbase radius is.
  protected final double effective_wheelbase_radius_; // m

  public SwerveDrive(final double wheel_radius, final double effective_wheelbase_radius) {
  ...
  public static class ChassisState {
    ...
    public Rotation2d254 heading;

    public ChassisState(Translation2d movement, Rotation2d254 heading) {
    ...
    public ChassisState(Translation2d movement) {
      this.movement = movement;
      this.heading = Rotation2d254.identity();
    }

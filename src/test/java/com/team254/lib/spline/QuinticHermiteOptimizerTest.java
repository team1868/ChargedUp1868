...
public class QuinticHermiteOptimizerTest {
  ...
  @Test
  public void test() {
    Pose2d a = new Pose2d(new Translation2d(0, 100), Rotation2d254.fromDegrees(270));
    Pose2d b = new Pose2d(new Translation2d(50, 0), Rotation2d254.fromDegrees(0));
    Pose2d c = new Pose2d(new Translation2d(100, 100), Rotation2d254.fromDegrees(90));
    ...
    Pose2d d = new Pose2d(new Translation2d(0, 0), Rotation2d254.fromDegrees(90));
    Pose2d e = new Pose2d(new Translation2d(0, 50), Rotation2d254.fromDegrees(0));
    Pose2d f = new Pose2d(new Translation2d(100, 0), Rotation2d254.fromDegrees(90));
    Pose2d g = new Pose2d(new Translation2d(100, 100), Rotation2d254.fromDegrees(0));
    ...
    Pose2d h = new Pose2d(new Translation2d(0, 0), Rotation2d254.fromDegrees(0));
    Pose2d i = new Pose2d(new Translation2d(50, 0), Rotation2d254.fromDegrees(0));
    Pose2d j = new Pose2d(new Translation2d(100, 50), Rotation2d254.fromDegrees(45));
    Pose2d k = new Pose2d(new Translation2d(150, 0), Rotation2d254.fromDegrees(270));
    Pose2d l = new Pose2d(new Translation2d(150, -50), Rotation2d254.fromDegrees(270));

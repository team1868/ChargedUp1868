...
public class SwerveSetpointGeneratorTest {
  ...
  protected final static SwerveSetpointGenerator.KinematicLimits kKinematicLimits =
  ...
  public void SatisfiesConstraints(SwerveSetpoint prev, SwerveSetpoint next) {
    for (int i = 0; i < prev.mModuleStates.length; ++i) {
      ...
      Rotation2d254 diffRotation = prevModule.angle.inverse().rotateBy(nextModule.angle);
      assertTrue(

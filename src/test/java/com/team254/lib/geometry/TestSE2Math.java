...
public class TestSE2Math {
  ...
  public void testRotation2d() {
    // Test constructors
    Rotation2d254 rot1 = new Rotation2d254();
    ...
    rot1 = new Rotation2d254(1, 1, true);
    ...
    rot1 = Rotation2d254.fromRadians(Math.PI / 2);
    ...
    rot1 = Rotation2d254.fromDegrees(270);
    Assert.assertEquals(0, rot1.cos(), kTestEpsilon);
    Assert.assertEquals(-1, rot1.sin(), kTestEpsilon);
    ...
    // Test inversion
    rot1 = Rotation2d254.fromDegrees(270);
    Rotation2d254 rot2 = rot1.inverse();
    ...
    rot1 = Rotation2d254.fromDegrees(1);
    rot2 = rot1.inverse();
    ...
    // Test rotateBy
    rot1 = Rotation2d254.fromDegrees(45);
    rot2 = Rotation2d254.fromDegrees(45);
    Rotation2d254 rot3 = rot1.rotateBy(rot2);
    ...
    Rotation2d254 identity = new Rotation2d254();
    rot1 = Rotation2d254.fromDegrees(21.45);
    ...
    // Test interpolation
    rot1 = Rotation2d254.fromDegrees(45);
    rot2 = Rotation2d254.fromDegrees(135);
  ...
  public void testTranslation2d() {
    ...
    Rotation2d254 rot1 = Rotation2d254.fromDegrees(90);
  ...
  public void testPose2d() {
    ...
    pose1 = new Pose2d(new Translation2d(3, 4), Rotation2d254.fromDegrees(45));
    ...
    // Test transformation
    pose1 = new Pose2d(new Translation2d(3, 4), Rotation2d254.fromDegrees(90));
    Pose2d pose2 = new Pose2d(new Translation2d(1, 0), Rotation2d254.fromDegrees(0));
    ...
    pose1 = new Pose2d(new Translation2d(3, 4), Rotation2d254.fromDegrees(90));
    pose2 = new Pose2d(new Translation2d(1, 0), Rotation2d254.fromDegrees(-90));
    ...
    pose1 = new Pose2d(new Translation2d(3.51512152, 4.23), Rotation2d254.fromDegrees(91.6));
    ...
    Assert.assertEquals(
        identity.getRotation().getDegrees(), pose2.getRotation().getDegrees(), kTestEpsilon
    );
    ...
    // centered at (3, -6)
    pose1 = new Pose2d(new Translation2d(3, 4), Rotation2d254.fromDegrees(90));
    pose2 = new Pose2d(new Translation2d(13, -6), Rotation2d254.fromDegrees(0.0));
    pose3 = pose1.interpolate(pose2, .5);
    double expected_angle_rads = Math.PI / 4;
    Assert.assertEquals(
        3.0 + 10.0 * Math.cos(expected_angle_rads), pose3.getTranslation().x(), kTestEpsilon
    );
    Assert.assertEquals(
        -6.0 + 10.0 * Math.sin(expected_angle_rads), pose3.getTranslation().y(), kTestEpsilon
    );
  ...
  public void testTwist() {
    ...
    pose = new Pose2d(new Translation2d(2.0, 2.0), Rotation2d254.fromRadians(Math.PI / 2));
    ...
    Assert.assertEquals(
        new_pose.getRotation().getDegrees(), pose.getRotation().getDegrees(), kTestEpsilon
    );
  }
}

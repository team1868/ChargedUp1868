...
public class MotionProfileGeneratorTest {
  public static Matcher<Double> epsilonEqualTo(final double b, final double epsilon) {
    return new BaseMatcher<Double>() {
      ...
      public void describeTo(Description description) {
        description.appendText("Should be within +/- ")
            .appendValue(epsilon)
            .appendText(" of ")
            .appendValue(b);
      }
  ...
  protected static void validateProfile(
    ...
    assertThat(
        profile.startState().vel(),
        epsilonEqualTo(
            Math.max(Math.min(start.vel(), constraints.max_vel()), constraints.min_vel()), kEpsilon
        )
    );
  ...
  protected static void validateProfile(
      MotionProfileConstraints constraints,
      LinearTimeVaryingMotionProfileGoal goal,
      MotionState start,
      MotionProfile profile,
      boolean ignore_goal
  ) {
  ...
  protected static void testProfile(
      MotionProfileConstraints constraints,
      MotionProfileGoal goal,
      MotionState start,
    ...
    testProfileFlipped(
        new MotionProfileConstraints(
            -constraints.min_vel(), -constraints.max_vel(), constraints.max_abs_acc()
        ),
        goal,
        start,
        expected_duration,
  ...
  protected static void testProfileForward(
      MotionProfileConstraints constraints,
      MotionProfileGoal goal,
      MotionState start,
      double expected_duration,
    ...
    MotionProfile positive_profile =
        MotionProfileGenerator.generateProfile(constraints, goal, start);
    assertThat(
        positive_profile.toString(),
        positive_profile.duration(),
        epsilonEqualTo(expected_duration, kEpsilon)
    );
    assertThat(
        positive_profile.toString(),
        positive_profile.length(),
        epsilonEqualTo(expected_length, kEpsilon)
    );
    validateProfile(constraints, goal, start, positive_profile);
  }

  protected static void testProfileFlipped(
      MotionProfileConstraints constraints,
      MotionProfileGoal goal,
      MotionState start,
      double expected_duration,
    ...
    MotionProfile negative_profile =
        MotionProfileGenerator.generateProfile(constraints, goal.flipped(), start.flipped());
    assertThat(
        negative_profile.toString(),
        negative_profile.duration(),
        epsilonEqualTo(expected_duration, kEpsilon)
    );
    assertThat(
        negative_profile.toString(),
        negative_profile.length(),
        epsilonEqualTo(expected_length, kEpsilon)
    );
  ...
  public void testAlreadyFinished() {
    // No initial velocity.
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(0.0),
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(2.0, 5.0),
        new MotionState(0.0, 2.0, 5.0, 7.0),
        0.0,
        0.0
    );
    ...
    testProfile(
        ...
        new MotionState(0.0, 2.0, 9.0, 7.0),
        0.0,
        0.0
    );
    // Initial velocity is too high, so allow infinite accel.
  ...
  public void testStationaryToStationary() {
    ...
    // Trapezoidal move.
    testProfile(
        new MotionProfileConstraints(10.0, -5.0, 5.0),
        new MotionProfileGoal(100.0),
        new MotionState(0.0, 0.0, 0.0, 0.0),
        12.0,
        100.0
  ...
  public void testMovingTowardsToStationary() {
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(100.0),
        new MotionState(0.0, 0.0, 10.0, 0.0),
        10.5,
        100.0
    );
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(10.0),
        new MotionState(0.0, 0.0, 5.0, 0.0),
        1.625,
        10.0
    );
  ...
  public void testStationaryToMoving() {
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(100.0, 10.0),
        new MotionState(0.0, 0.0, 0.0, 0.0),
        10.5,
        100.0
    );
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(100.0, 5.0),
        new MotionState(0.0, 0.0, 0.0, 0.0),
        10.625,
        100.0
    );
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(1.0, 10.0),
        new MotionState(0.0, 0.0, 0.0, 0.0),
        Math.sqrt(1.0 / 5.0),
        1.0
    );
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(8.75, 5.0),
        new MotionState(0.0, 0.0, 0.0, 0.0),
        1.5,
        8.75
    );
  ...
  public void testMovingTowardsToMoving() {
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(3.75, 10.0),
        new MotionState(0.0, 0.0, 5.0, 0.0),
        0.5,
        3.75
    );
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(10.0, 5.0),
        new MotionState(0.0, 0.0, 10.0, 0.0),
        1.125,
        10.0
    );
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(1.0, 10.0),
        new MotionState(0.0, 0.0, 4.0, 0.0),
        0.2,
        1.0
    );
  ...
  public void testMovingAwayToMoving() {
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new MotionProfileGoal(8.75, 5.0),
        new MotionState(0.0, 5.0, -10.0, 0.0),
        2.5,
        13.75
    );
  }
  ...
  public void problematicCase1() {
    MotionProfile profile = MotionProfileGenerator.generateProfile(
        new MotionProfileConstraints(50.0, -50.0, 25.0),
        new MotionProfileGoal(200.0),
        new MotionState(0.0, 0.0, 0.0, 0.0)
    );
  ...
  public void testAsymmetricVelocityLimits() {
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -5.0, 10.0),
  ...
  public void testLinearTimeVaryingGoal() {
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new LinearTimeVaryingMotionProfileGoal(0.0, 100.0, 0.0),
        new MotionState(0.0, 0.0, 0.0, 0.0),
        11.0,
        100.0
    );
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new LinearTimeVaryingMotionProfileGoal(0.0, 10.0, 5.0),
        new MotionState(0.0, 0.0, 0.0, 0.0),
        3.25,
        26.25
    );
    ...
    testProfile(
        new MotionProfileConstraints(10.0, -10.0, 10.0),
        new LinearTimeVaryingMotionProfileGoal(0.0, 10.0, -5.0),
        new MotionState(0.0, 0.0, 2.0, 0.0),
        1.5315914,
        4.842043
    );

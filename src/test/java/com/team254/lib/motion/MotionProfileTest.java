...
public class MotionProfileTest {
  ...
  public void setUp() {
    ...
    segments.add(
        new MotionSegment(new MotionState(0.0, 0.0, 0.0, 1.0), new MotionState(1.0, 0.5, 1.0, 1.0))
    );
    // Cruise at 1 unit/s for 1 second
    segments.add(
        new MotionSegment(new MotionState(1.0, 0.5, 1.0, 0.0), new MotionState(2.0, 1.5, 1.0, 0.0))
    );
    // Decelerate at -1 unit/s^2 for 1 second
    segments.add(new MotionSegment(
        new MotionState(2.0, 1.5, 1.0, -1.0), new MotionState(3.0, 2.0, 0.0, -1.0)
    ));

    segments_reversed = new ArrayList<>();
    // Accelerate at -1 unit/s^2 for 1 second
    segments_reversed.add(new MotionSegment(
        new MotionState(3.0, 2.0, 0.0, -1.0), new MotionState(4.0, 1.5, -1.0, -1.0)
    ));
    // Cruise at -1 unit/s for 1 second
    segments_reversed.add(new MotionSegment(
        new MotionState(4.0, 1.5, -1.0, 0.0), new MotionState(5.0, 0.5, -1.0, 0.0)
    ));
    // Decelerate at -1 unit/s^2 for 1 second
    segments_reversed.add(
        new MotionSegment(new MotionState(5.0, 0.5, -1.0, 1.0), new MotionState(6.0, 0.0, 0.0, 1.0))
    );
  ...
  public void isValid() {
    MotionProfile a = new MotionProfile();
    a.appendSegment(
        new MotionSegment(new MotionState(0.0, 0.0, 0.0, 0.0), new MotionState(0.0, 0.0, 0.0, 1.0))
    );
    assertFalse(a.isValid());

    a = new MotionProfile();
    a.appendSegment(
        new MotionSegment(new MotionState(0.0, 0.0, 0.0, 1.0), new MotionState(1.0, 0.0, 1.0, 1.0))
    );
    assertFalse(a.isValid());

    a = new MotionProfile();
    a.appendSegment(
        new MotionSegment(new MotionState(0.0, 0.0, 0.0, 1.0), new MotionState(1.0, .5, 1.0, 1.0))
    );
    assertTrue(a.isValid());
  }
  ...
  public void appendSegment() {
    ...
    // 3 second trapezoid traveling a displacement of 2 units. Peak velocity of 1.0 units/s.
    a.appendSegment(
        new MotionSegment(new MotionState(3.0, 2.0, 0.0, 1.0), new MotionState(4.0, 2.5, 1.0, 1.0))
    );
    a.appendSegment(
        new MotionSegment(new MotionState(4.0, 2.5, 1.0, 0.0), new MotionState(5.0, 3.5, 1.0, 0.0))
    );
    a.appendSegment(new MotionSegment(
        new MotionState(5.0, 3.5, 1.0, -1.0), new MotionState(6.0, 4.0, 0.0, -1.0)
    ));
    assertFalse(a.isEmpty());
    assertTrue(a.isValid());
    assertThat(a.startPos(), is(equalTo(0.0)));
  ...
  public void stateByTime() {
    ...
    assertThat(
        a.stateByTime(3.5).get(), is(equalTo(segments_reversed.get(0).start().extrapolate(3.5)))
    );
    assertThat(a.stateByTime(4.0).get(), is(equalTo(segments_reversed.get(0).end())));
    assertThat(
        a.stateByTime(4.25).get(), is(equalTo(segments_reversed.get(1).start().extrapolate(4.25)))
    );
  ...
  public void firstStateByPos() {
    ...
    assertThat(
        a.firstStateByPos(1.0).get(), is(equalTo(segments_reversed.get(1).start().extrapolate(4.5)))
    );
